...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {led_dbg}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_dbg}]
set_property PACKAGE_PIN E19 [get_ports {led_dbg1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_dbg1}]
